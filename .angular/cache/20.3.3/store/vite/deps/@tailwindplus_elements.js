...
var require_dist = __commonJS({
  "node_modules/@tailwindplus/elements/dist/index.js"(exports) {
    var Sn = Object.defineProperty;
    var Eo = (e) => {
      throw TypeError(e);
    };
    var Ln = (e, o, t) => o in e ? Sn(e, o, { enumerable: true, configurable: true, writable: true, value: t }) : e[o] = t;
    var C = (e, o, t) => Ln(e, typeof o != "symbol" ? o + "" : o, t);
    var kt = (e, o, t) => o.has(e) || Eo("Cannot " + t);
    var f = (e, o, t) => (kt(e, o, "read from private field"), t ? t.call(e) : o.get(e));
    var L = (e, o, t) => o.has(e) ? Eo("Cannot add the same private member more than once") : o instanceof WeakSet ? o.add(e) : o.set(e, t);
    var I = (e, o, t, n) => (kt(e, o, "write to private field"), n ? n.call(e, t) : o.set(e, t), t);
    var M = (e, o, t) => (kt(e, o, "access private method"), t);
    ...
    var lt = class extends Event {
      constructor(o, _a = {}) {
        var _b = _a, { oldState: t = "", newState: n = "" } = _b, r = __objRest(_b, ["oldState", "newState"]);
        super(o, r);
        C(this, "oldState");
        C(this, "newState");
    ...
    var In = globalThis.HTMLDialogElement || function() {
    };
    ...
    function Mt(e) {
      ...
      e.classList.add(":popover-open"), Se.set(e, "showing"), nt.has(o) || nt.set(o, /* @__PURE__ */ new Set()), nt.get(o).add(e), Do(it.get(e), true), Mn(e), t && a && e.popover === "auto" && st.set(e, a), ko(e, "closed", "open");
    }
    ...
    function he(e, o, t) {
      ...
      if (e instanceof Document) return Hn(i, o, t);
...
`;
    ...
    function Mo() {
      ...
      let i = (l) => {
        ...
        if (!(p instanceof Element) || p?.shadowRoot) return;
        let c = Le(p);
        if (!(c instanceof Po || c instanceof Document)) return;
        let g = u.find((v) => {
          var d;
    ...
    function Ro() {
      ...
      function e(d, m, h = true) {
        Object.defineProperty(d, m, __spreadProps(__spreadValues({}, Object.getOwnPropertyDescriptor(d, m)), { enumerable: h }));
      }
      function o(d) {
      ...
      class r extends Event {
        ...
        get source() {
          ...
          let m = t.get(this);
          if (!(m instanceof Element)) return null;
          let h = o(m);
      ...
      function a(d) {
        Object.defineProperties(d.prototype, { commandForElement: { enumerable: true, configurable: true, set(m) {
          ...
          if (m === null) this.removeAttribute("commandfor"), s.delete(this);
          ...
          let m = s.get(this);
          if (m) return m.isConnected ? m : (s.delete(this), null);
      ...
      function u(d) {
        for (let m of d) m.oncommand = new Function("event", m.getAttribute("oncommand"));
      }
      ...
      function c(d) {
        ...
        if (m && (console.warn("Elements with `invoketarget` or `invokeaction` are deprecated and should be renamed to use `commandfor` and `command` respectively"), m.matches("input"))) throw new Error("Input elements no longer support `commandfor`");
        let h = d.target.closest("button[commandfor], button[command]");
        if (!h) return;
        if (h.form && h.getAttribute("type") !== "button") throw d.preventDefault(), new Error("Element with `commandFor` is a form participant. It should explicitly set `type=button` in order for `commandFor` to work. In order for it to act as a Submit button, it must not have command or commandfor attributes");
        ...
        if (w.dispatchEvent(y), y.defaultPrevented) return;
    ...
    typeof globalThis.window < "u" && (Co() || (Mo(), at(() => __async(null, null, function* () {
      if (yield Fn("popover-polyfill")) return;
    ...
    function qn() {
      return __async(this, null, function* () {
        yield Promise.all(Array.from(document.querySelectorAll('link[rel="stylesheet"]')).map((e) => e.sheet ? Promise.resolve() : new Promise((o) => {
    ...
    var Un = /* @__PURE__ */ new Set(["top", "bottom"]);
    function se(e) {
    ...
    var Uo = (e, o, t) => __async(null, null, function* () {
      let { placement: n = "bottom", strategy: r = "absolute", middleware: i = [], platform: s } = t, a = i.filter(Boolean), l = yield s.isRTL == null ? void 0 : s.isRTL(o), u = yield s.getElementRects({ reference: e, floating: o, strategy: r }), { x: p, y: c } = Ko(u, n, l), g = n, v = {}, d = 0;
      for (let m = 0; m < a.length; m++) {
        let { name: h, fn: w } = a[m], { x: y, y: b, data: A, reset: E } = yield w({ x: p, y: c, initialPlacement: n, placement: g, strategy: r, middlewareData: v, rects: u, platform: s, elements: { reference: e, floating: o } });
        p = y ?? p, c = b ?? c, v = __spreadProps(__spreadValues({}, v), { [h]: __spreadValues(__spreadValues({}, v[h]), A) }), E && d <= 50 && (d++, typeof E == "object" && (E.placement && (g = E.placement), E.rects && (u = E.rects === true ? yield s.getElementRects({ reference: e, floating: o, strategy: r }) : E.rects), { x: p, y: c } = Ko(u, g, l)), m = -1);
      }
    ...
    function Vt(e, o) {
      return __async(this, null, function* () {
        var t;
        o === void 0 && (o = {});
        let { x: n, y: r, platform: i, rects: s, elements: a, strategy: l } = e, { boundary: u = "clippingAncestors", rootBoundary: p = "viewport", elementContext: c = "floating", altBoundary: g = false, padding: v = 0 } = ft(o, e), d = _o(v), h = a[g ? c === "floating" ? "reference" : "floating" : c], w = ve(yield i.getClippingRect({ element: (t = yield i.isElement == null ? void 0 : i.isElement(h)) == null || t ? h : h.contextElement || (yield i.getDocumentElement == null ? void 0 : i.getDocumentElement(a.floating)), boundary: u, rootBoundary: p, strategy: l })), y = c === "floating" ? { x: n, y: r, width: s.floating.width, height: s.floating.height } : s.reference, b = yield i.getOffsetParent == null ? void 0 : i.getOffsetParent(a.floating), A = (yield i.isElement == null ? void 0 : i.isElement(b)) ? (yield i.getScale == null ? void 0 : i.getScale(b)) || { x: 1, y: 1 } : { x: 1, y: 1 }, E = ve(i.convertOffsetParentRelativeRectToViewportRelativeRect ? yield i.convertOffsetParentRelativeRectToViewportRelativeRect({ elements: a, rect: y, offsetParent: b, strategy: l }) : y);
    ...
    var jo = function(e) {
      return e === void 0 && (e = {}), { name: "flip", options: e, fn(o) {
        return __async(this, null, function* () {
          var t, n;
          let { placement: r, middlewareData: i, rects: s, initialPlacement: a, platform: l, elements: u } = o, _a2 = ft(e, o), { mainAxis: p = true, crossAxis: c = true, fallbackPlacements: g, fallbackStrategy: v = "bestFit", fallbackAxisSideDirection: d = "none", flipAlignment: m = true } = _a2, h = __objRest(_a2, ["mainAxis", "crossAxis", "fallbackPlacements", "fallbackStrategy", "fallbackAxisSideDirection", "flipAlignment"]);
          if ((t = i.arrow) != null && t.alignmentOffset) return {};
          let w = be(r), y = se(a), b = be(a) === a, A = yield l.isRTL == null ? void 0 : l.isRTL(u.floating), E = g || (b || !m ? [_e(a)] : Wo(a)), S = d !== "none";
          !g && S && E.push(...$o(a, m, d, A));
          let H = [a, ...E], ce = yield Vt(o, h), D = [], ne = ((n = i.flip) == null ? void 0 : n.overflows) || [];
          if (p && D.push(ce[w]), c) {
            let fe = Vo(r, s, A);
          ...
          if (ne = [...ne, { placement: r, overflows: D }], !D.every((fe) => fe <= 0)) {
            ...
            if (Pt && (!(c === "alignment" ? y !== se(Pt) : false) || ne.every((W) => se(W.placement) === y ? W.overflows[0] > 0 : true))) return { data: { index: fe, overflows: ne }, reset: { placement: Pt } };
    ...
    var zo = function(e) {
      return e === void 0 && (e = {}), { name: "shift", options: e, fn(o) {
        return __async(this, null, function* () {
          let { x: t, y: n, placement: r } = o, _a2 = ft(e, o), { mainAxis: i = true, crossAxis: s = false, limiter: a = { fn: (h) => {
            let { x: w, y } = h;
            return { x: w, y };
          } } } = _a2, l = __objRest(_a2, ["mainAxis", "crossAxis", "limiter"]), u = { x: t, y: n }, p = yield Vt(o, l), c = se(be(r)), g = Nt(c), v = u[g], d = u[c];
          if (i) {
          ...
          let m = a.fn(__spreadProps(__spreadValues({}, o), { [g]: v, [c]: d }));
          return __spreadProps(__spreadValues({}, m), { data: { x: m.x - t, y: m.y - n, enabled: { [g]: i, [c]: s } } });
        });
      } };
    };
    function pt() {
    ...
    var Zn = ["transform", "translate", "scale", "rotate", "perspective"];
    var er = ["transform", "translate", "scale", "rotate", "perspective", "filter"];
    var tr = ["paint", "layout", "strict", "content"];
    function mt(e) {
    ...
    var or = /* @__PURE__ */ new Set(["html", "body", "#document"]);
    function ye(e) {
      return or.has(we(e));
    }
    function V(e) {
    ...
    var ur = /* @__PURE__ */ new Set(["absolute", "fixed"]);
    function cr(e, o) {
    ...
    function Zo(e, o, t) {
      let n;
      if (o === "viewport") n = ar(e, t);
      else if (o === "document") n = lr(_(e));
      else if (q(o)) n = cr(o, t);
      else {
        let r = on(e);
    ...
    var hr = function(e) {
      return __async(this, null, function* () {
        let o = this.getOffsetParent || sn, t = this.getDimensions, n = yield t(e.floating);
        return { reference: mr(e.reference, yield o(e.floating), e.strategy), floating: { x: 0, y: 0, width: n.width, height: n.height } };
      });
    };
    function gr(e) {
      return V(e).direction === "rtl";
    }
    var Kt = { convertOffsetParentRelativeRectToViewportRelativeRect: ir, getDocumentElement: _, getClippingRect: dr, getOffsetParent: sn, getElementRects: hr, getClientRects: sr, getDimensions: pr, getScale: Me, isElement: q, isRTL: gr };
    function ln(e, o) {
    ...
    function br(e, o) {
      ...
      function s(a, l) {
        ...
        try {
          t = new IntersectionObserver(E, __spreadProps(__spreadValues({}, b), { root: r.ownerDocument }));
        } catch {
    ...
    var cn = jo;
    var fn = (e, o, t) => {
      let n = /* @__PURE__ */ new Map(), r = __spreadValues({ platform: Kt }, t), i = __spreadProps(__spreadValues({}, r.platform), { _c: n });
      return Uo(e, o, __spreadProps(__spreadValues({}, r), { platform: i }));
    };
    function pn(e, o) {
      let t = () => {
      };
      return function(r) {
        ...
        a !== "absolute" && a !== "fixed" && (console.warn(`[createAnchorUpdater] Invalid anchor strategy "${a}" for element:`, e), a = "absolute"), t = an(i, e, () => {
          ...
          fn(i, e, { strategy: a, placement: s.replace(" ", "-"), middleware: [cn({ padding: c }), un({ padding: c })] }).then((_0) => __async(null, [_0], function* ({ x: g, y: v, placement: d }) {
            if (!vr() && a === "absolute") {
              let w = null;
            ...
            Object.assign(e.style, { left: m, top: h, position: a }), (yield Kt.isRTL?.(e)) && Object.assign(e.style, { right: "unset", bottom: "unset" });
          }));
        });
      };
    }
    ...
    var Qt = class extends x {
      ...
      mount(t) {
        ...
        let s = this;
        function a() {
          for (let c of i.getItems()) c.getAttribute("role") !== "option" && (c.id || (c.id = P("option")), c.setAttribute("role", "option"), c.setAttribute("aria-selected", "false"), c.setAttribute("tabIndex", "-1"), c.addEventListener("mousedown", (g) => {
        ...
        for (let c of p) c.setAttribute("aria-disabled", "true"), c.setAttribute("aria-selected", "false");
    ...
    var Jt = class extends x {
      ...
      mount(t) {
        ...
        function s(l = false) {
          var u;
          for (let p of r.getItems()) p.getAttribute("role") !== "option" && (p.id || (p.id = P("item")), p.setAttribute("role", "option"), p.setAttribute("tabIndex", "-1"), p.setAttribute("aria-selected", "false"), p.hasAttribute("disabled") && p.setAttribute("aria-disabled", "true"), ae(p, "mouseover", t, () => {
            var c;
    ...
    typeof globalThis.window < "u" && (Re = HTMLDialogElement.prototype.close, Object.defineProperties(HTMLDialogElement.prototype, { close: { value() {
      ...
      let o = e.beforeClose();
      if (o === true) return Re?.apply(this, arguments);
    ...
    var Be = class extends x {
      ...
      mount(t) {
        ...
        for (let a of M(this, Ze, io).call(this)) a.setAttribute("aria-expanded", r.toString());
        Or(n, t, (a) => {
          a.preventDefault();
      ...
      onAttributeChange(t, n, r) {
        switch (t) {
          case "open": {
            ...
            for (let s of M(this, Ze, io).call(this)) s.setAttribute("aria-expanded", r !== null ? "true" : "false");
    ...
    var At = class extends x {
      ...
      mount(t) {
        ...
        for (let i of M(this, et, ao).call(this)) le(i, t, n), i.setAttribute("aria-expanded", r.toString()), i.setAttribute("aria-controls", this.id);
      ...
      onAttributeChange(t, n, r) {
        switch (t) {
          case "hidden": {
            ...
            for (let i of M(this, et, ao).call(this)) i.setAttribute("aria-expanded", r === null ? "true" : "false");
    ...
    function Tt(e, o, t) {
      ...
      function l() {
        ...
        for (let S of b) S.getAttribute("role") !== E && (S.id || (S.id = P("item")), S.setAttribute("role", E), S.setAttribute("tabIndex", "-1"), S.addEventListener("click", () => o.onItemClick(S), A), ae(S, "mouseover", t, () => v(S, false)), ae(S, "mouseout", t, () => d()));
      }
      l();
      ...
      a.addEventListener("pointerdown", (b) => {
        ...
        if (b.button !== 0 || a.matches(":disabled") || !e.hasAttribute("open")) return;
        if (Date.now() - (p ?? 0) > Dr) {
      ...
      function h(b, A = false) {
        ...
        if (!A && H && ce !== -1 && B(H) && (H.textContent?.trim().toLowerCase() || "").startsWith(S)) return H;
        for (let D = ce + 1; D < E.length; D++) if ((E[D].textContent?.trim().toLowerCase() || "").startsWith(S) && B(E[D])) return E[D];
        for (let D = 0; D <= ce; D++) if ((E[D].textContent?.trim().toLowerCase() || "").startsWith(S) && B(E[D])) return E[D];
        return null;
      }
      function w(b) {
        let A = r === "";
    ...
    oe = /* @__PURE__ */ new WeakMap(), xe = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), ot = /* @__PURE__ */ new WeakSet(), uo = function() {
...
*/
//# sourceMappingURL=@tailwindplus_elements.js.map
